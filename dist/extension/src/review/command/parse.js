...
export function parseReviewCommand(input) {
    ...
    for (let index = 0; index < args.length; index += 1) {
        ...
        if (arg === "--fixture") {
            ...
            if (!name || name.startsWith("-")) {
                throw new ReviewCommandParseError("Missing fixture name after --fixture.");
            }
            fixture = name;
            index += 1;
            continue;
        ...
        throw new ReviewCommandParseError(`Unexpected positional argument: ${arg}.`);
    }
    if (base && fixture) {
        throw new ReviewCommandParseError("--fixture cannot be combined with --base.");
    }
    if (fixture && agent) {
        throw new ReviewCommandParseError("--fixture cannot be combined with --agent.");
    }
    return {
        kind: "review",
        ...(base ? { base } : {}),
