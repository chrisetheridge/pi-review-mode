...
export default function reviewModeExtension(pi) {
    const agentReviews = new AgentReviewCoordinator();
    pi.registerTool?.({
        name: "submit_review_mode_comments",
        label: "Submit review-mode comments",
        description: "Submit structured comments for a pending /review --agent pre-review. Use only when review mode asks for it.",
        promptSnippet: "submit_review_mode_comments: submit structured comments for a pending /review --agent pre-review.",
    ...
    pi.registerCommand("review", {
        description: "Open a native review window for commenting on a frozen Git diff.",
