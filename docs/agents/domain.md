...
| Browser review UI | `src/review-web/**` | Changing file tree, unified diff rendering, comment editors, saved comment cards, submit blocking, close behavior, API client, or styling. | PRD sections: Browser review UI, Comment behavior, Data loading |
...
| Web UI tests | `src/review-web/**/*.test.tsx` | Adding or changing UI rendering and browser interaction tests. | PRD acceptance criteria for browser UI and comment behavior |
