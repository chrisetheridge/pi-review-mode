import type { ReviewAnchor, ReviewSnapshot } from "../snapshot/types.js";
...
export function buildAgentReviewPrompt(
  ...
  lines.push(
    ...
    "- Tags are optional. A comment may include multiple tags, one tag, or no tags.",
    "- Valid tags: `spec`, `standards`, `bug`.",
    "- Omit tags rather than inventing new categories.",
    "- Use `spec` only when the comment is grounded in an identifiable requirement.",
    "- For `spec`, try to infer relevant requirements from available docs, issue context, specs, README behavior, tests, or code comments.",
    "- Do not use `spec` when no relevant requirement can be inferred. Do not invent requirements.",
    "- Use `standards` for project conventions, codebase architecture, style, maintainability, boundaries, naming, or testing expectations.",
    "- Use `bug` for likely incorrect behavior, runtime failures, broken edge cases, data loss, security issues, or test failures.",
